  ...
  [40],
  {
      ...
      var o = (function (t) {
        ...
        function i(r) {
          var e,
            ...
            o = r.initOptions,
            i = void 0 === o ? {} : o,
            u = r.constructorOptions,
            c = void 0 === u ? {} : u,
            s = r.loginOptions,
            a = void 0 === s ? {} : s;
          return (
            ((e = t.call(this, { supportedChainIds: [n] }) || this).chainId =
              n),
            (e.initOptions = i),
            (e.constructorOptions = c),
            (e.loginOptions = a),
            e
          );
        }
              ...
              var t = this,
                r = function () {
                  return Promise.resolve(
                    t.torus.login(t.loginOptions).then(function (t) {
                      return t[0];
                    })
                  ).then(function (r) {
                    return { provider: t.torus.provider, account: r };
                  });
                },
                n = (function () {
                  if (!t.torus)
                    return Promise.resolve(
                      Promise.all([e.e(21), e.e(34)])
                        .then(e.bind(null, 1932))
                        .then(function (t) {
                          var r;
                          return null != (r = null == t ? void 0 : t.default)
                            ? r
                            : t;
                        })
                    ).then(function (r) {
                      return (
                        (t.torus = new r(t.constructorOptions)),
                        Promise.resolve(t.torus.init(t.initOptions)).then(
                          function () {}
                        )
                      );
                    });
          ...
          (u.close = function () {
            try {
              ...
              return Promise.resolve(t.torus.cleanUp()).then(function () {
                (t.torus = void 0), t.emitDeactivate();
              });
            } catch (r) {
    ...
    940: function (t, r, e) {
      ...
      var i = (function (t) {
        ...
        function n(r) {
          var e,
            n = (void 0 === r ? {} : r).supportedChainIds;
          return ((e = t.call(this) || this).supportedChainIds = n), e;
        }
        (e = t),
