(this["webpackJsonpdexfinance-frontend"] =
  ...
  [39],
  {
    887: function (t, e, r) {
      "use strict";
      r.r(e),
        r.d(e, "PortisConnector", function () {
          return s;
        });
      var n = r(940),
        o = r(12);
        ...
        s = (function (t) {
          ...
          function s(e) {
            ...
            return (
              ...
              ((r = t.call(this, { supportedChainIds: h }) || this).dAppId = n),
              (r.networks = i),
              (r.config = u),
              (r.handleOnLogout = r.handleOnLogout.bind(c(r))),
              (r.handleOnActiveWalletChanged =
                r.handleOnActiveWalletChanged.bind(c(r))),
              (r.handleOnError = r.handleOnError.bind(c(r))),
              r
            );
          }
          (n = t),
          ...
          var u = s.prototype;
          return (
            (u.handleOnLogout = function () {
              this.emitDeactivate();
            }),
            (u.handleOnActiveWalletChanged = function (t) {
              this.emitUpdate({ account: t });
            }),
            (u.handleOnError = function (t) {
              this.emitError(t);
            }),
            (u.activate = function () {
              try {
            ...
            (u.changeNetwork = function (t, e) {
              try {
                return (
                  "number" === typeof t
                    ? (a[t] || Object(o.a)(!1),
                      this.portis.changeNetwork(a[t], e),
                      this.emitUpdate({ chainId: t }))
                    : (this.portis.changeNetwork(t, e),
                      this.emitUpdate({ chainId: Number(t.chainId) })),
                  Promise.resolve()
                );
              } catch (r) {
