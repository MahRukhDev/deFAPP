(this["webpackJsonpdexfinance-frontend"] =
  ...
  [38],
  {
    886: function (e, t, n) {
      "use strict";
      n.r(t),
        n.d(t, "InjectedConnector", function () {
          return p;
        }),
        n.d(t, "NoEthereumProviderError", function () {
          return l;
        }),
      ...
      var l = (function (e) {
        ...
        p = (function (e) {
          function t(t) {
            var n;
            return (
              ((n = e.call(this, t) || this).handleNetworkChanged =
          ...
          var n = t.prototype;
          return (
            (n.handleChainChanged = function (e) {
            ...
            (n.handleNetworkChanged = function (e) {
              this.emitUpdate({ chainId: e, provider: window.ethereum });
            }),
            (n.activate = function () {
              try {
                var e,
                  ...
                  n = !1;
                if (!window.ethereum) throw new l();
                window.ethereum.on &&
                ...
                var r = f(
                  ...
                  function (e) {
                    if (4001 === e.code) throw new m();
                  }
                );
                return Promise.resolve(r && r.then ? r.then(t) : t(r));
              } catch (i) {
            ...
            (n.getChainId = function () {
              try {
                var e,
                  t = function () {
                    function t() {
                      ...
                      return (
                        e ||
                          (e = window.ethereum.isDapper
                            ? w(window.ethereum.cachedResults.net_version)
                    ...
                    var n = (function () {
                      if (!e) {
                        var t = f(
                          function () {
                            return Promise.resolve(
                              window.ethereum.send("net_version").then(w)
                            ).then(function (t) {
                              e = t;
                            });
                          },
                ...
                var n = f(
                  function () {
                    return Promise.resolve(
                      window.ethereum.send("eth_chainId").then(w)
                    ).then(function (t) {
                      e = t;
                    });
                  },
            ...
            (n.getAccount = function () {
              try {
                ...
                var n = f(
                  function () {
                    return Promise.resolve(
                      window.ethereum.send("eth_accounts").then(function (e) {
                        return w(e)[0];
                      })
                    ).then(function (t) {
                      e = t;
