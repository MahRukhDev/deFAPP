(this["webpackJsonpdexfinance-frontend"] =
  ...
  [37],
  {
    884: function (t, e, r) {
      "use strict";
      r.r(e),
        r.d(e, "FortmaticConnector", function () {
          return c;
        });
      var n = r(940),
        i = r(12);
        ...
        c = (function (t) {
          ...
          function c(e) {
            var r,
              ...
              c = e.chainId;
            return (
              Object.keys(o).includes(c.toString()) || Object(i.a)(!1),
              ((r = t.call(this, { supportedChainIds: [c] }) || this).apiKey =
                n),
              (r.chainId = c),
              r
            );
          ...
          return (
            ...
            (a.close = function () {
              try {
                var t = this;
                return Promise.resolve(t.fortmatic.user.logout()).then(
                  function () {
                    t.emitDeactivate();
                  }
                );
      ...
      var o = (function (t) {
        ...
        return (
          (o.emitUpdate = function (t) {
            this.emit(i.a.Update, t);
          }),
          (o.emitError = function (t) {
            this.emit(i.a.Error, t);
          }),
          (o.emitDeactivate = function () {
            this.emit(i.a.Deactivate);
          }),
          n
        );
      })(n.EventEmitter);
